...
},{"buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"engine/keyboard/keyboard.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Keyboard(engine) {
    ...
    this.engine = engine;
    this.keysPress = new Map();

    this.listenerUp = function (event) {
      event.preventDefault();
      event.stopPropagation();

      _this.keysPress.delete((0, lodash_1.snakeCase)(event.key));

      _this.keysPress.delete((0, lodash_1.snakeCase)(event.code));
    };

    this.listenerDown = function (event) {
      event.preventDefault();
      event.stopPropagation();

      _this.keysPress.set((0, lodash_1.snakeCase)(event.key), true);

      _this.keysPress.set((0, lodash_1.snakeCase)(event.code), true);
    };
  ...
  Keyboard.prototype.press = function (verify) {
    if (verify) {
      var keys = verify.split(".");

      for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
        var key = keys_1[_i];

        if (!this.keysPress.has((0, lodash_1.snakeCase)(key))) {
          return false;
        }
      }
...
},{"lodash":"../node_modules/lodash/lodash.js"}],"engine/gameobjects/gameobjects.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function GameObjects(engine) {
    this.engine = engine;
    this.objects = [];
  }

  GameObjects.prototype.add = function (object) {
    this.objects.push(object);
  };

  GameObjects.prototype.remove = function (object) {
    object.destroy();
    delete this.objects[this.objects.indexOf(object)];
  };

  GameObjects.prototype.draw = function (context) {
  ...
  GameObjects.prototype.update = function (fps, context) {
  ...
  GameObjects.prototype.detectCollisions = function () {
    for (var _i = 0, _a = this.objects; _i < _a.length; _i++) {
      var object = _a[_i];
...
},{}],"engine/gameobjects/gameobject-factory.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function GameObjectFactory(engine) {
    this.engine = engine;
  }

  GameObjectFactory.prototype.create = function (object) {
    var _a;
    ...
    var instance = new ((_a = object).bind.apply(_a, __spreadArray([void 0], params, false)))();
...
},{}],"engine/maps/map.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Maps(engine, width, height) {
    this.engine = engine;
    this.image = null;
    this._width = 0;
    this._height = 0;
  ...
  Object.defineProperty(Maps.prototype, "width", {
    get: function get() {
      return this._width;
    },
  ...
  Object.defineProperty(Maps.prototype, "height", {
    get: function get() {
      return this._height;
    },
  ...
  Maps.prototype.draw = function (context) {
    var width = this.image.width;
    var height = this.image.height;
    context.drawImage(this.image, 0, 0, width, height, 0, 0, width, height);
  };

  Maps.prototype.generate = function () {
    var context = document.createElement("canvas").getContext("2d");
    context.canvas.width = this._width;
    context.canvas.height = this._height;
    var rows = ~~(this._width / 40) + 1;
    var columns = ~~(this._height / 40) + 1;
    context.save();

    for (var row = 0, index = 0; index < rows; row += 40, index++) {
      for (var col = 0, index2 = 0; index2 < columns; col += 40, index2++) {
        if (index % 2 === 0) {
...
exports.Maps = Maps;
},{}],"engine/math/vector2.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Vector2.prototype.setFromObject = function (obj) {
  ...
  Vector2.prototype.subtractX = function (x) {
    this.x -= x || 0;
    return this;
  };

  Vector2.prototype.subtractY = function (y) {
    this.y -= y || 0;
    return this;
  };
  ...
  Vector2.prototype.multiplyX = function (x) {
    this.x *= x || 0;
    return this;
  };

  Vector2.prototype.multiplyY = function (y) {
    this.y *= y || 0;
    return this;
  };
  ...
  Vector2.prototype.divideX = function (x) {
    this.x /= x || 0;
    return this;
  };

  Vector2.prototype.divideY = function (y) {
    this.y /= y || 0;
    return this;
  };
  ...
  Vector2.prototype.distance = function (vector) {
    var dx = this.x - (vector.x || 0);
    var dy = this.y - (vector.y || 0);
...
},{}],"engine/camera/camera.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Camera(engine, view) {
    ...
    this.view = new vector2_1.Vector2(view || {
  ...
  Camera.prototype.updateViewport = function () {
    ...
    this.viewport.scale.x = this.engine.context.canvas.width / this.viewport.width;
    this.viewport.scale.y = this.engine.context.canvas.height / this.viewport.height;
  };
  ...
  Camera.prototype.addListeners = function () {
    ...
    this.engine.canvas.addEventListener("wheel", function (event) {
      event.preventDefault();
      event.stopPropagation();

      if (event.ctrlKey) {
        var _a = _this.engine.canvas.getBoundingClientRect(),
            top = _a.top,
            left = _a.left,
            width = _a.width,
            height = _a.height;

        var zoomLevel = _this.distance + event.deltaY / 1.5;

        if (zoomLevel <= 1) {
          zoomLevel = 1;
        }

        var offsetX = event.x - left;
        var offsetY = event.y - top;

        _this.zoomTo(zoomLevel);

        _this.moveTo({
          x: _this.view.x - (offsetX - width / 2) * event.deltaY / 1000,
          y: _this.view.y - (offsetY - height / 2) * event.deltaY / 1000
        });
      } else if (event.shiftKey) {
        _this.moveTo({
          x: _this.view.x - event.deltaY / 2.5,
          y: _this.view.y - event.deltaX / 2.5
        });
      } else {
        _this.moveTo({
          x: _this.view.x + event.deltaX / 2.5,
          y: _this.view.y + event.deltaY / 2.5
        });
      }
    });
...
},{"./../math/vector2":"engine/math/vector2.ts"}],"engine/engine.ts":[function(require,module,exports) {
"use strict";
...
var gameobject_factory_1 = require("./gameobjects/gameobject-factory");
...
function () {
  function Engine(width, height) {
    ...
    this.maps = new map_1.Maps(this, 5000, 5000);
    this.keyboard = new keyboard_1.Keyboard(this);
    this.objects = new gameobjects_1.GameObjects(this);
    this.factory = new gameobject_factory_1.GameObjectFactory(this);
  ...
  Engine.prototype.update = function (time) {
    ...
    this.lastTime = time; // this.camera.moveTo();
  ...
  Engine.prototype.drawFPS = function () {
    ...
    var widthText = this.context.measureText("FPS: " + Math.round(1 / this.fps));
    this.context.fillText("FPS: " + Math.round(1 / this.fps), this.canvas.width - widthText.width - 15, 20);
...
window.onload = function () {
  ...
  var player = engine.factory.create(player_1.Player, {
    x: 20,
    y: 20
  });
